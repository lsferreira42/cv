...
{Setembro 2022 - Até o presente momento} % Date(s)
{
...
{Getninjas} % Organization
{São Paulo, SP} % Location
{Fevereiro 2020 - Setembro 2022} % Date(s)
{
  \begin{cvitems} % Description(s) of tasks/responsibilities
  ...
  \cventry
    {Especialista de arquitetura de sistemas} % Job title
    {Locaweb} % Organization
    {São Paulo, SP} % Location
    {Janeiro. 2019 - Fevereiro, 2020} % Date(s)
    {
      \begin{cvitems} % Description(s) of tasks/responsibilities
       ...
       \item \quad {Autorização de deploy ( Python ).}
       \item \quad {Notificação de erros e logs ( Java ).}
  ...
  \cventry
    ...
    {São Paulo, SP} % Location
    {Janeiro. 2018 - Janeiro 2019} % Date(s)
    {
      \begin{cvitems} % Description(s) of tasks/responsibilities
  ...
  \cventry
    ...
    {Viavarejo/Casas Bahia} % Organization
    {São Caetano, SP} % Location
    {Setembro. 2017 - Dezembro. 2017 / Contrato por tempo fixo.} % Date(s)
    {
      \begin{cvitems} % Description(s) of tasks/responsibilities
...
%---------------------------------------------------------
  \cventry
    ...
    {Light Cloud Serviços de Internet \(Midgar\)} % Organization
    {São Paulo, SP} % Location
